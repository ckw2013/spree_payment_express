module Spree
  class PaymentExpressCallbacksController < Spree::BaseController
    ...
    def notify
      ...
      @notification = Payment::Notification.new(request.raw_post)
    ...
    private
      def retrieve_details
        ...
        if @order
          @payment = @order.payments.where(:state => "pending", :source_type => "PaymentExpressAccount").try(:first)
